...
class MainApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def adjustUI(self):
        ...
        self.actionTTCPlot.triggered.connect(self.add_on_open_ttc_plot)
    ...
    def add_on_open_ttc_plot(self):
        self.ttc_window = TTCPlotApp(self.main_dict, self.plot_add_new)
        self.ttc_window.show()
